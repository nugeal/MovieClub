                ...
                <div id="add-event-form">
                    <form class="form-horizontal" role="form" 
                        ...
                        <div class="form-group">
                            <label for="edit-event-date" class="col-md-3 control-label">
                                Date:
                            </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="${event.event_id}" name="event_id" hidden/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit-member" class="col-md-3 control-label">
                                Host:
                            </label>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" placeholder="Member" name="member" required>
                                    ...
                                    <option selected>${event.member.member_id} - ${event.member.first_name} ${event.member.last_name}</option>
                        ...
                        <div class="form-group">
                            <label for="edit-event-theme" class="col-md-3 control-label">
                                Theme:
                            </label>
                        ...
                        <div class="form-group">
                            <label for="edit-movie" class="col-md-3 control-label">
                                Movie:
                            </label>
